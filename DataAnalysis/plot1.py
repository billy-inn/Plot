...
ax0.plot(x,y,'o-',label='atomic')

fr.close()

fr = open('./Fermi/naive_noatomic.txt',"r")
...
ax0.plot(x,y,'x-',label='non-atomic')
...
ax1.plot(x,y,'o-',label='atomic')

fr.close()

fr = open('./Kepler/naive_noatomic.txt',"r")
...
ax1.plot(x,y,'x-',label='non-atomic')
